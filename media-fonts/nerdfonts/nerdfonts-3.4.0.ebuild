...
# Upstream tarballs unpack .ttf/.otf files flat into ${WORKDIR}, not into
# a per-package subdirectory, so the default S=${WORKDIR}/${P} points at
# a non-existent path and prepare fails.
S="${WORKDIR}"
