...
PATCHES=(
	...
	"${FILESDIR}/${P}-bash-action-timeout-env.patch"
	"${FILESDIR}/${P}-unbranded-animation.patch"
	"${FILESDIR}/${P}-context-label.patch"
	"${FILESDIR}/${P}-line-levels.patch"
	"${FILESDIR}/${P}-hide-level-caps.patch"
	"${FILESDIR}/${P}-hide-recording-cursor.patch"
)
